    ...
    <div className="max-w-[1520] mx-auto flex justify-between items-center p-4">
      ...
      {sideNav && (
        <div
          ...
          className="bg-black/60 cursor-pointer fixed w-full h-screen z-10 left-0 top-0"
        ></div>
      )}
      <div
        className={
          sideNav
            ? 'bg-white w-[200px] md:w-[300px] h-screen fixed top-0 left-0 z-10 duration-300'
            : 'bg-white w-[200px]  md:w-[300px] h-screen fixed top-0 left-[-300px] z-10 duration-300'
        }
      >
        <AiOutlineClose
          onClick={() => setSideNav(!sideNav)}
